    ...
    rpcConsole(0)
{
    ...
    QString windowTitle = tr("SPP-Coin") + " - " + tr("Wallet");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SPP-Coin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SPP-Coin"), this);
    aboutAction->setToolTip(tr("Show information about SPP-Coin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for SPP-Coin"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SPP-Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SPP-Coin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SPP-Coin address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateMintingIcon()
{
    ...
    {	
        ...
        labelMintingIcon->setPixmap(QIcon(":/icons/mining_active").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
