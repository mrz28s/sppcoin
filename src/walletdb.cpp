             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
		...
		else if (strType == "stakeSplitThreshold") //presstab SPP-Coin
		{
            ssValue >> pwallet->nStakeSplitThreshold;
		}
		else if (strType == "multisend") //presstab SPP-Coin
		{
			unsigned int i;
			ssKey >> i;
		...
		else if(strType == "msettings")//presstab SPP-Coin
		{
