...
static const uint256 hashGenesisBlockOfficial("0x31f94c24a0d31af92ae42650e99a153bd233a493143ae9bfff880c6943e58481");
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge, unsigned int& nAge) const;  // ppcoin: get transaction coin age
...
public:
    ...
    uint256 GetHash() const
    {
            return Hash(BEGIN(nVersion), END(nNonce)); //SHA
    }
